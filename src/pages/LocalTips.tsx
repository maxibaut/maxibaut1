...
import { Download, Store, UtensilsCrossed, ShoppingBag, ChefHat, MapPin, Phone, Globe, Mail, ScrollText, ClipboardCheck, FileText, Shield, ChevronRight } from 'lucide-react';
