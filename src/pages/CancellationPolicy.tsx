...
import { Download, ScrollText, ClipboardCheck, Store, FileText, Shield, ChevronRight, Car } from 'lucide-react';
                  ...
                  <section className="mb-10">
                    ...
                    <div className="grid gap-4">
                      {tiers.map((tier, index) => (
                        <div 
                          key={index} 
                          className="border border-border/50 rounded-lg p-5 bg-card hover:border-primary/30 transition-colors"
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                            <h3 className="font-medium text-foreground">{tier.period}</h3>
                            <span className="text-primary font-semibold">{tier.refund}</span>
                          </div>
