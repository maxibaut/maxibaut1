      ...
      <div className="container-luxury">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          <div className="md:col-span-2 rounded-lg overflow-hidden shadow-md aspect-[4/3] md:aspect-[16/9]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4403.470904866242!2d4.960254777559448!3d50.012070618829796!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c1dc0a433b3a8f%3A0x7315788d91c91cbd!2sArdenNest%20Gedinne!5e1!3m2!1snl!2sbe!4v1777921916993!5m2!1snl!2sbe"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
